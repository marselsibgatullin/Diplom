<form class="form-add" method="post" action="/posts/edit/<?php echo $_SESSION['news']['id']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" id="tittle" class="form-control" name="tittle" placeholder="Заголовок вакансии" value="<?php echo $_SESSION['news']['tittle'];?>">
        </div>
    </div>
    <div class="form-group">
        <label for="name" class="col-sm-2 control-label">Выбор специальности</label>
        <div class="col-sm-8">
            <select id="speciality" class="form-control" name="speciality" value="<?php echo $_SESSION['news']['speciality'];?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" id="text" name="text"><?php echo $_SESSION['news']['text'];?></textarea>
        </div>
    </div>
    <div class="form-group">
